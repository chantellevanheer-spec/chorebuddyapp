...
export default function ConfirmDialog({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={`funky-card max-w-md border-4 ${variant === 'warning' ? 'border-[#FF6B35]' : 'border-red-500'}`}>
        <DialogHeader>
          <DialogTitle className={`header-font text-2xl flex items-center gap-3 ${variant === 'warning' ? 'text-[#FF6B35]' : 'text-red-600'}`}>
